(function () {
  ...
  1: [function (require, module, exports) {
    ...
    function calculator() {
      ...
      place = document.getElementById('select'), totalValue = document.getElementById('total'), personsSum = 0, daySum = 0, daySumArr = [], personsSumArr = [], alterniteTotal = 0, total = 0;
  ...
  2: [function (require, module, exports) {
    ...
    function learnMoreTab() {
        ...
        request.onreadystatechange = function () {
          if (request.readyState < 4) {
            ...
            if (request.status === 200 && request.status < 300) {
              statusMessage.innerHTML = "<img id=img  src = 'http://localhost/lessons/lesson_14/img/loadComplete.jpg'>"; //Добавден контент на страницу
            } else {
      ...
      formContact.addEventListener('submit', function (event) {
        event.preventDefault();
        formContact.appendChild(statusMessage); //AJAX
        ...
        request.onreadystatechange = function () {
          if (request.readyState < 4) {
            ...
            if (request.status === 200 && request.status < 300) {
              statusMessage.innerHTML = message.success; //Добавден контент на страницу
            } else {
              statusMessage.innerHTML = message.failure;
            }
          }
        ...
        for (let i = 0; i < input.length; i++) {
          inputContact[i].value = ''; //Очищаем поля ввода
        }
      });
    }
  ...
  7: [function (require, module, exports) {
    ...
    "../js/parts/calculator.js": 1,
    "../js/parts/learn_more_tab.js": 2,
    "../js/parts/model.js": 3,
    "../js/parts/slider.js": 4,
    "../js/parts/tab.js": 5,
    "../js/parts/timer.js": 6
  }]
}, {}, [7]);